...
function Hero() {
    return (
        <div className="bg-[url(/assets/images/webp/hero-bg.webp)] bg-cover bg-no-repeat">
            ...
            <Image src={'/assets/images/gif/pizza-peperuney.gif'} alt="pizza" width={1920} height={356} className="mx-auto pointer-events-none mt-[34px] max-sm:mt-[95px] object-cover max-sm:w-full max-sm:h-[262px]" />
            <CustomMarquee/>
        </div>
    )
}
