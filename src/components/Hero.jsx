    ...
    return (
        <div className="bg-[url(/assets/images/webp/hero-bg.webp)] bg-cover bg-no-repeat">
            ...
            <div className="relative mt-[158px] max-sm:mt-[206px]">
                ...
                <Image src={'/assets/images/webp/hero.webp'} alt="hero" height={317} width={341} className="max-lg:!w-[200px] max-xl:w-[300px] absolute -top-32 max-lg:-top-16 max-[830px]:-top-24 max-sm:-top-32 left-1/2 -translate-x-1/2 hero max-sm:min-w-[252px]"/>
            </div>
            <CustomMarquee/>
        </div>
    )
