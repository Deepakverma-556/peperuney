        ...
        <div className="bg-[url(/assets/images/webp/meet-peperuney.webp)] bg-cover bg-no-repeat bg-center">
            ...
            <div className="max-w-[1332px] pt-24 max-[404px]:pt-32 mx-auto flex max-lg:flex-wrap-reverse max-sm:pr-2 pb-[1030px] max-lg:pb-[550px]">
                ...
                <div className="relative flex items-center flex-col justify-center">
                    ...
                    <Image src={'/assets/images/png/pizza-guy.png'} alt="pizza-guy" width={715} height={509} className="absolute pointer-events-none max-[1315px]:h-full z-10 top-0 left-0 max-lg:w-full max-sm:w-full" />
                    <Image src={'/assets/images/png/pizza-sticker.png'} alt="pizza-sticker" width={337} height={102} className="absolute pointer-events-none z-10 -top-10 left-1/2 -translate-x-1/2 max-sm:w-[195px] max-sm:h-[77px]" />
