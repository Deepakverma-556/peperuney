...
function MeetPeperuney() {
    return (
        <div className="bg-[url(/assets/images/webp/meet-peperuney.webp)] bg-cover bg-no-repeat bg-center">
            <Image src={'/assets/images/webp/melting-cheese.webp'} alt="melting-cheese" height={272} width={1920} className="w-full object-cover max-sm:h-[201px]" />
            <div className="max-w-[1332px] pt-24 max-[404px]:pt-32 mx-auto flex max-lg:flex-wrap-reverse max-sm:pr-2 pb-[1030px] max-lg:pb-[550px]">
                <Image src={'/assets/images/gif/cloud-peperuney.gif'} alt="cloud" width={580} height={530} className="max-lg:mx-auto max-sm:-mt-20 z-20" />
                <div className="relative flex items-center flex-col justify-center">
                    <Heading myClass={'-mt-24 text-center max-[404px]:-mt-32'} text={"MEET PEPERUNEY"} />
                    <Image src={'/assets/images/png/pizza-guy.png'} alt="pizza-guy" width={715} height={509} className="absolute max-[1315px]:h-full z-10 top-0 left-0 max-lg:w-full max-sm:w-full" />
                    <Image src={'/assets/images/png/pizza-sticker.png'} alt="pizza-sticker" width={337} height={102} className="absolute z-10 -top-10 left-1/2 -translate-x-1/2 max-sm:w-[195px] max-sm:h-[77px]" />
                    <div className="px-16 max-sm:pl-8 max-sm:pr-4 relative z-20 pt-16 max-lg:pt-20 pb-20 max-sm:pt-20 max-sm:pb-12">
