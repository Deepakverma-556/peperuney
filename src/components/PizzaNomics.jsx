...
const PizzaNomics = () => {
    return (
      ...
      <div className="bg-[url(/assets/images/webp/pizzanomics-bg.webp)] bg-cover bg-no-repeat">
          <Image src={'/assets/images/webp/pizzanomics-small.webp'} alt="small" height={900} width={700} className="sm:hidden w-full max-sm:h-[1600px]"/>
          <div className="sm:pt-[777px] max-sm:pt-8 max-w-[1200px] mx-auto flex items-center max-lg:flex-wrap justify-between">
              ...
              <Image src={'/assets/images/webp/peperuney-holding-a-paper.webp'} alt="peperuney" height={851} width={656} className="xl:-mr-16 lg:mt-10 max-xl:w-[450px] max-lg:w-[300px] max-sm:h-[300px] max-sm:w-[300px] max-lg:mx-auto"/>
          </div>
              ...
              <div className="flex items-center justify-center gap-4 max-sm:gap-10 flex-wrap">
                  {PIZZANOMICS_ICONS_LIST.map((obj, i) => (
                      <Link key={i} href={"/"} className="group">
                          <Image src={obj.image} alt={obj.imageAlt} height={140} width={360} className="max-sm:h-[92px] max-sm:w-[236px] transition-all duration-300 group-hover:scale-105" />
                      </Link>
                  ))}
              </div>
          </div>
